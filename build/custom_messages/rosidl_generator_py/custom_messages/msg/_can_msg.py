...
class Metaclass_CanMsg(type):
    """Metaclass of message 'CanMsg'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'custom_messages.msg.CanMsg')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__can_msg
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__can_msg
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__can_msg
            cls._TYPE_SUPPORT = module.type_support_msg__msg__can_msg
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__can_msg
...
class CanMsg(metaclass=Metaclass_CanMsg):
    """Message class 'CanMsg'."""
    ...
    def can_id(self, value):
        if __debug__:
            ...
            assert value >= 0 and value < 65536, \
                "The 'can_id' field must be an unsigned integer in [0, 65535]"
        self._can_id = value
