...
bool custom_messages__msg__yolo_detection__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("custom_messages.msg._yolo_detection.YoloDetection", full_classname_dest, 49) == 0);
  }
  custom_messages__msg__YoloDetection * ros_message = _ros_message;
  {  // class_id
...
PyObject * custom_messages__msg__yolo_detection__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("custom_messages.msg._yolo_detection");
