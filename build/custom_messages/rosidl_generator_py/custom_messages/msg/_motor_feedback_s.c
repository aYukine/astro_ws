...
bool custom_messages__msg__motor_feedback__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("custom_messages.msg._motor_feedback.MotorFeedback", full_classname_dest, 49) == 0);
  }
  custom_messages__msg__MotorFeedback * ros_message = _ros_message;
  {  // motor_id
...
PyObject * custom_messages__msg__motor_feedback__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("custom_messages.msg._motor_feedback");
