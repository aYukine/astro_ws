...
#include "custom_messages/msg/detail/yolo_detection__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = custom_messages::msg::YoloDetection;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const custom_messages::msg::YoloDetection *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<custom_messages::msg::YoloDetection *>(
    untyped_ros_message);
...
{
  return &custom_messages::msg::typesupport_fastrtps_cpp::_YoloDetection__handle;
}
