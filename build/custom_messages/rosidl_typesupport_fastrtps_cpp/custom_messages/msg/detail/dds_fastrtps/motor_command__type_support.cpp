...
#include "custom_messages/msg/detail/motor_command__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const custom_messages::msg::MotorCommand & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  custom_messages::msg::MotorCommand & ros_message)
{
  // Member: motor_id
  cdr >> ros_message.motor_id;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = custom_messages::msg::MotorCommand;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const custom_messages::msg::MotorCommand *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<custom_messages::msg::MotorCommand *>(
    untyped_ros_message);
...
{
  return &custom_messages::msg::typesupport_fastrtps_cpp::_MotorCommand__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_messages, msg, MotorCommand)() {
  return &custom_messages::msg::typesupport_fastrtps_cpp::_MotorCommand__handle;
}
