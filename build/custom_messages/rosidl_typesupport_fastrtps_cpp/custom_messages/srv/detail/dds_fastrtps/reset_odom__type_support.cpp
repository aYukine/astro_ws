...
#include "custom_messages/srv/detail/reset_odom__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const custom_messages::srv::ResetOdom_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  custom_messages::srv::ResetOdom_Request & ros_message)
{
  // Member: structure_needs_at_least_one_member
  cdr >> ros_message.structure_needs_at_least_one_member;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = custom_messages::srv::ResetOdom_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const custom_messages::srv::ResetOdom_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<custom_messages::srv::ResetOdom_Request *>(
    untyped_ros_message);
...
{
  return &custom_messages::srv::typesupport_fastrtps_cpp::_ResetOdom_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_messages, srv, ResetOdom_Request)() {
  return &custom_messages::srv::typesupport_fastrtps_cpp::_ResetOdom_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_custom_messages
cdr_serialize(
  const custom_messages::srv::ResetOdom_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: success
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  custom_messages::srv::ResetOdom_Response & ros_message)
{
  // Member: success
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = custom_messages::srv::ResetOdom_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const custom_messages::srv::ResetOdom_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<custom_messages::srv::ResetOdom_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &custom_messages::srv::typesupport_fastrtps_cpp::_ResetOdom_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_messages, srv, ResetOdom_Response)() {
  return &custom_messages::srv::typesupport_fastrtps_cpp::_ResetOdom_Response__handle;
}
...
{
  return &custom_messages::srv::typesupport_fastrtps_cpp::_ResetOdom__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_messages, srv, ResetOdom)() {
  return &custom_messages::srv::typesupport_fastrtps_cpp::_ResetOdom__handle;
}
