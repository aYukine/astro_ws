...
{
  new (message_memory) custom_messages::msg::CanMsg(_init);
}

void CanMsg_fini_function(void * message_memory)
{
  auto typed_message = static_cast<custom_messages::msg::CanMsg *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember CanMsg_message_member_array[2] = {
  {
    ...
    offsetof(custom_messages::msg::CanMsg, can_id),  // bytes offset in struct
  ...
  },
  {
    ...
    8,  // array size
    false,  // is upper bound
    offsetof(custom_messages::msg::CanMsg, data),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers CanMsg_message_members = {
  ...
  "CanMsg",  // message name
  2,  // number of fields
  sizeof(custom_messages::msg::CanMsg),
...
get_message_type_support_handle<custom_messages::msg::CanMsg>()
{
  return &::custom_messages::msg::rosidl_typesupport_introspection_cpp::CanMsg_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, custom_messages, msg, CanMsg)() {
  return &::custom_messages::msg::rosidl_typesupport_introspection_cpp::CanMsg_message_type_support_handle;
}
