...
#include "custom_messages/srv/detail/reset_odom__rosidl_typesupport_fastrtps_c.h"
...
using _ResetOdom_Request__ros_msg_type = custom_messages__srv__ResetOdom_Request;
...
size_t get_serialized_size_custom_messages__srv__ResetOdom_Request(
  const void * untyped_ros_message,
...
static uint32_t _ResetOdom_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_custom_messages__srv__ResetOdom_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_custom_messages
size_t max_serialized_size_custom_messages__srv__ResetOdom_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = custom_messages__srv__ResetOdom_Request;
    is_plain =
      (
...
static size_t _ResetOdom_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_custom_messages__srv__ResetOdom_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, custom_messages, srv, ResetOdom_Request)() {
...
using _ResetOdom_Response__ros_msg_type = custom_messages__srv__ResetOdom_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_custom_messages
size_t get_serialized_size_custom_messages__srv__ResetOdom_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _ResetOdom_Response__ros_msg_type * ros_message = static_cast<const _ResetOdom_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_custom_messages__srv__ResetOdom_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_custom_messages
size_t max_serialized_size_custom_messages__srv__ResetOdom_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = custom_messages__srv__ResetOdom_Response;
    is_plain =
      (
...
static size_t _ResetOdom_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_custom_messages__srv__ResetOdom_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, custom_messages, srv, ResetOdom_Response)() {
...
// already included above
// #include "custom_messages/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "custom_messages/srv/reset_odom.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, custom_messages, srv, ResetOdom)() {
