...
#include "custom_messages/msg/detail/motor_feedback__rosidl_typesupport_fastrtps_c.h"
...
using _MotorFeedback__ros_msg_type = custom_messages__msg__MotorFeedback;
...
size_t get_serialized_size_custom_messages__msg__MotorFeedback(
  const void * untyped_ros_message,
...
static uint32_t _MotorFeedback__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_custom_messages__msg__MotorFeedback(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_custom_messages
size_t max_serialized_size_custom_messages__msg__MotorFeedback(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = custom_messages__msg__MotorFeedback;
    is_plain =
      (
...
static size_t _MotorFeedback__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_custom_messages__msg__MotorFeedback(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, custom_messages, msg, MotorFeedback)() {
