...
static const _ResetOdom_Request_type_support_symbol_names_t _ResetOdom_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, custom_messages, srv, ResetOdom_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, custom_messages, srv, ResetOdom_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, custom_messages, srv, ResetOdom_Request)() {
  return &::custom_messages::srv::rosidl_typesupport_c::ResetOdom_Request_message_type_support_handle;
}
...
static const _ResetOdom_Response_type_support_symbol_names_t _ResetOdom_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, custom_messages, srv, ResetOdom_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, custom_messages, srv, ResetOdom_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, custom_messages, srv, ResetOdom_Response)() {
  return &::custom_messages::srv::rosidl_typesupport_c::ResetOdom_Response_message_type_support_handle;
}
...
static const _ResetOdom_type_support_symbol_names_t _ResetOdom_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, custom_messages, srv, ResetOdom)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, custom_messages, srv, ResetOdom)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, custom_messages, srv, ResetOdom)() {
  return &::custom_messages::srv::rosidl_typesupport_c::ResetOdom_service_type_support_handle;
}
