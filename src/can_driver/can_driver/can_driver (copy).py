...
class CanDriver(Node):
    ...
    def init_publisher(self):
        self.encoder_publisher = self.create_publisher(EncoderFeedback, '/motor_feedback', 10)
    ...
    def on_message_received(self, msg):
        ...
        if 500 <= msg.arbitration_id <= 510:
            ...
            feedback_msg.digital1 = msg.data[0] & 0x01
            feedback_msg.digital2 = (msg.data[0] >> 1) & 1
            feedback_msg.digital3 = (msg.data[0] >> 2) & 1
            feedback_msg.digital4 = (msg.data[0] >> 3) & 1

            feedback_msg.analog1 = ((msg.data[1] << 8) + (msg.data[2] >> 4)) / 4095.0
            feedback_msg.analog2 = (((msg.data[2] >> 4) << 8) + msg.data[3]) / 4095.0
            feedback_msg.analog3 = ((msg.data[4] << 8) + (msg.data[5] >> 4)) / 4095.0
            feedback_msg.analog4 = (((msg.data[5] >> 4) << 8) + msg.data[6]) / 4095.0
